...
const ProductDetailForm = lazy(() =>
  import("../pages/Productpages/ProductDetails/ProductDetailForm")
);
      ...
      <div className="app-container">
        <main className="main-content">
          ...
          <Routes>
            ...
            <Route path="/catalog/:categorySlug" element={<OurCatlog />} />
            <Route
              path="/catalog/:categorySlug/:subcategorySlug"
              element={<OurCatlog />}
            />
            <Route
              path="/catalog/:categorySlug/:subcategorySlug/:productSlug"
