      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            if (container.classList.contains("text-first")) {
              // For text-first sections (text on left, image on right)
              content.classList.add("slide-in-left");
              image.classList.add("slide-in-right");
            } else {
              // For image-first sections (image on left, text on right)
  ...
  return (
    <div className="about-us-wrapper">
      {items.map((item, index) => {
        // Determine if this should be text-first (text left, image right)
          ...
          >
            <div
              className={`about-us-container ${
                isTextFirst ? "text-first" : "image-first"
              }`}
            >
              {isTextFirst ? (
                <>
                  <div className="about-us-content">
                    ...
                    <ul className="about-us-list">
                      ...
                      {item.subcontent?.map((subpoint, i) => (
                        <li
                          key={`sub-${i}`}
                          className="about-us-list-item subcontent"
                        >
                          <span>- {subpoint}</span>
                        </li>
                      ))}
